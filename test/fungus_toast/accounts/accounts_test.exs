defmodule FungusToast.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{active: true, user_name: "some user_name"}
    @update_attrs %{active: false, user_name: "some updated user_name"}
    ...
    test "delete_user/1 deactivates the user" do
      user = user_fixture()
