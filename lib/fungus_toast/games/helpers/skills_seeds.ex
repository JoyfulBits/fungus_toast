defmodule FungusToast.Skills.SkillsSeed do
  ...
  def seed_active_skills do
    ...
    upsert_active_skill(%{
      ...
      description:
        "Allows you to increase the UV lamp light setting by 1 unit, decreasing the growth of most fungal cells by 0.2%.",
    ...
    upsert_active_skill(%{
      ...
      description:
        "Allows you to decrease the UV lamp light setting by 1 unit, increasing the growth of most fungal cells by 0.2%.",
