defmodule FungusToast.Games.Grid do
  ...
  def generate_growth_cycles(starting_grid, grid_size, player_id_to_player_map, generation_number, acc) when generation_number < 6 do
    ...
    |> generate_growth_cycles(grid_size, player_id_to_player_map, generation_number + 1, acc ++ [growth_cycle])
  end

  def generate_growth_cycles(ending_grid, _, _, _, acc), do: %{growth_cycles: acc, new_game_state: ending_grid}
