...
Games.create_skill(%{name: "Regeneration", description: "Increases the chance that your live cell will regenerate an adjacent dead cell (from any player).", increase_per_point: 0.5, up_is_good: true})
